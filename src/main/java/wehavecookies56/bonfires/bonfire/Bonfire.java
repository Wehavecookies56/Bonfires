...
public class Bonfire implements INBTSerializable<CompoundTag> {
    ...
    public void deserializeNBT(CompoundTag tag) {
        ...
        this.dimension = ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(tag.getString("DIM")));
        this.pos = new BlockPos(tag.getDouble("POSX"), tag.getDouble("POSY"), tag.getDouble("POSZ"));
